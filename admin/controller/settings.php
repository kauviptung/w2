...
$menuList = [
  ...
  "Các mô-đun" => "modules",
  "Cài đặt hỗ trợ" => "subject",
  "Tiền thưởng thanh toán" => "payment-bonuses",
  "Quản lý tiền tệ của trang web" => "currency-manager",
  "Cài đặt thông báo" => "alert",
  "Đơn hàng giả" => "site_count"
];
