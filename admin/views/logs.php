                  ...
                  <table class="table table-striped">
                          ...
                          <th class="checkAll-th">
                             ...
                             <div class="action-block">
                                <ul class="action-list" style="margin:5px 0 0 0!important">
                                   <li><span class="countlogs"></span> Nhật ký đã chọn</li>
                                   <li>
                                      <div class="dropdown">
                     ...
                     <form id="changebulkForm" action="<?php echo site_url("admin/logs/multi-action") ?>" method="post">
                       <tbody>
                         <?php if( !$logs ): ?>
                           <tr>
                             <td><center>Không tìm thấy nhật ký</center></td>
                           </tr>
                         <?php endif; ?>
                         <?php foreach($logs as $log): ?>
                          <tr>
                            <td><input type="checkbox" class="selectOrder" name="log[<?php echo $log["id"] ?>]" value="1" style="border:1px solid #fff"></td>
                             ...
                             <td> <a href="<?php echo site_url("admin/logs/delete/".$log["id"]) ?>" style="font-size:12px">Xóa</a> </td>
                          </tr>
                        <?php endforeach; ?>
                       </tbody>
