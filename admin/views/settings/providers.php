...
<div class="settings-header__table">
            ...
            <div class="col-md-5">
	<div class="settings-header__table">
		<button type="button" class="btn btn-default m-b" data-toggle="modal" data-target="#modalDiv" data-action="new_provider">Thêm Nhà cung cấp mới</button>
	</div>
...
echo '<div class="tooltip5">  <span class="fas fa-info-circle"></span><span class="tooltiptext5">Thông tin số dư không có sẵn cho nhà cung cấp đó</span></div>'  ;
