<?php include 'header.php'; ?>
 <div class="container container-md"> <div class="row"><div class="col-md-12">
                  <ul class="nav nav-tabs"> <a href="/admin/tickets" class="details_backButton btn btn-link"><span>‹</span> Trở lại</a><li class="pull-right custom-search">
       ...
       <div class="col-md-12">
        ...
        <div class="row">
		   ...
		   <?php echo $ticketMessage[0]["subject"]; echo ' <span class="service-block__provider-value">';
               ...
               <span class="badge"><i class="fa fa-lock"></i> Yêu cầu hỗ trợ đã bị khóa, Người dùng không thể trả lời.</span>
               <?php endif; ?>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <form action="<?php echo site_url("admin/tickets/read/".$ticketMessage[0]["ticket_id"]) ?>" method="post">
                              ...
                              <div class="col-md-12">
                                 <button class="btn btn-primary click" type="submit">Đặt hàng</button>
                                 <div class="btn-group">
                                   <?php if( $ticketMessage[0]["client_new"] == 1 ): ?>
                                     <a href="<?php echo site_url("admin/tickets/unread/".$ticketMessage[0]["ticket_id"]) ?>" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="Đánh dấu là chưa đọc">Đánh dấu là chưa đọc</a>
                                   <?php endif; if( $ticketMessage[0]["canmessage"] == 2 ): ?>
                                     <a href="<?php echo site_url("admin/tickets/lock/".$ticketMessage[0]["ticket_id"]) ?>" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="Khóa yêu cầu hỗ trợ">Khóa vé</a>
                                   <?php else: ?>
                                     <a href="<?php echo site_url("admin/tickets/unlock/".$ticketMessage[0]["ticket_id"]) ?>" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mở khóa yêu cầu hỗ trợ">Mở khóa vé</a>
                                   <?php endif; if( $ticketMessage[0]["status"] != "closed" ): ?>
                                     <a href="<?php echo site_url("admin/tickets/close/".$ticketMessage[0]["ticket_id"]) ?>" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="" data-original-title="Đóng yêu cầu hỗ trợ">Đóng vé</a>
                                   <?php endif; ?>
</div>
                              </div>
                           </form>
...
<a data-toggle="modal" data-target="#modalDiv" data-action="edit_ticket" data-id="<?=$message['id']?>">Chỉnh sửa</a> • <a href="<?php echo site_url("admin/tickets/remove/".$ticketMessage[0]["id"]) ?>">Delete</a>
