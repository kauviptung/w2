...
<h5 align="center">Thêm một lớp bảo mật bổ sung vào trang quản trị.</h5>
<h6 align="center">Quét Mã QR bên dưới hoặc Nhập Mã bên dưới vào <a target="_blank" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2"> Google Authenticator</a> App.</h6>
<img class="rounded mx-auto d-block mb-2" style="height:250px;width:250px;" src="data:image/png;base64,<?=$encoded_qr_data?>" alt="Mã QR thiết lập Google Authenticator">
...
<label class="form-label" for="2FA_Code">6-Mã số từ ứng dụng Google Authenticator</label>
<input type="hidden" id="secret_key" name="secret_key" value="<?=$GoogleTFA_admin->google2fa_secret?>">
<div class="mb-3">
  <input id="2FA_Code" type="number" class="form-control" name="2FA_Code" placeholder="Nhập mã" autocomplete="off">
  </div>
<div class="d-grid gap-2">
 <button type="submit" class="btn btn-primary">Bật Xác minh hai bước</button>
<a class="btn btn-warning" href="<?=site_url("admin")?>">Bỏ qua ngay bây giờ</a>
</div>
</form>
    </div>
