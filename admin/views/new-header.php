  ...
  <header>
    ...
    <div class="mobile-navbar">
      <div class="logo-details">
        <div class="logo_name"><a href="">SmmView.Pro</a></div>
      </div>
      ...
      <ul class="nav-list">
        ...
        ?>">
          ...
          <div class="content">
            <a class="nav-link <?php if (route(1) == "clients") {
              echo "active";
                ...
                height="30" width="30" src="<?php echo site_url("img/admin/users.png"); ?>"> Quản lý Thành viên</a>
          ...
          <a class="nav-link <?php if (route(1) == "fund-add-history") {
            ...
            <span class="links_name">Lịch sử Thêm tiền</span>
          </a>
            ...
            <a class="nav-link <?php if (route(1) == "special-pricing") {
              echo "active";
                ...
                height="30" width="30" src="<?php echo site_url("img/admin/special-pricing.png"); ?>"> Giá
              đặc biệt</a>
          </div>
        </li>
        <li class="dropdown <?php
        ...
        ?>">
          <a class="nav-link" href="javascript:void(0)">
            ...
            <span class="links_name">Dịch vụ</span><i class="bi bi-chevron-right arrow"></i>
          </a>
          <div class="content">
            <a class="nav-link  <?php if (route(1) == "services") {
              echo "active";
            } ?>" href="<?php echo site_url("admin/services"); ?>"><img class="img-responsive nav-li-href-logo"
                height="30" width="30" src="<?php echo site_url("img/admin/services.png"); ?>"> Quản lý Dịch vụ</a>
            <a class="nav-link  <?php if (route(1) == "category-sort") {
              echo "active";
                ...
                height="30" width="30" src="<?php echo site_url("img/admin/category-sort.png"); ?>"> Sắp xếp Danh mục</a>
            <a class="nav-link  <?php if (route(1) == "update-prices") {
              echo "active";
                ...
                height="30" width="30" src="<?php echo site_url("img/admin/update-prices.png"); ?>"> Cập nhật giá</a>
            <a class="nav-link  <?php if (route(1) == "bulk") {
              echo "active";
                ...
                width="30" src="<?php echo site_url("img/admin/bulk-services-edit.png"); ?>"> Biên tập viên dịch vụ hàng loạt</a>
            <a class="nav-link  <?php if (route(1) == "synced_logs") {
              echo "active";
                ...
                height="30" width="30" src="<?php echo site_url("img/admin/synced-logs.png"); ?>"> Nhật ký đồng bộ của người bán</a>
          </div>
        </li>
        <li class="dropdown">
          <a class="nav-link" href="javascript:void(0)">
            ...
            <span class="links_name">Đơn hàng</span><i class="bi bi-chevron-right arrow"></i>
          </a>
          <div class="content">
            <a class="nav-link" href="<?php echo site_url("admin/orders"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/orders.png"); ?>"> Quản lý đơn hàng</a>
            <a style="font-size:14px;" class="nav-link" href="<?php echo site_url("admin/tasks"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/cancel-refill-tasks.png"); ?>"> Hủy và Nạp lại Nhiệm vụ</a>
          </div>
        </li>
        ...
        <li>
          <a class="nav-link" href="<?php echo site_url("admin/tickets"); ?>">
            ...
            <span class="links_name">Hỗ trợ</span>
          </a>
        </li>
        ...
        <li class="dropdown">
          <a class="nav-link" href="javascript:void(0)">
            ...
            <span class="links_name">Bổ sung</span><i class="bi bi-chevron-right arrow"></i>
          </a>
          <div class="content">
            <a class="nav-link" href="<?php echo site_url("admin/referrals"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/referrals.png"); ?>"> Các chi nhánh</a>
            <a class="nav-link" href="<?php echo site_url("admin/broadcasts"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/broadcasts.png"); ?>"> Phát sóng</a>
            <a class="nav-link" href="<?php echo site_url("admin/logs"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/logs.png"); ?>"> Nhật ký hệ thống</a>

            <a class="nav-link" href="<?php echo site_url("admin/reports"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/reports.png"); ?>"> Thống kê</a>
            <a class="nav-link" href="<?php echo site_url("admin/kuponlar"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/coupons.png"); ?>"> Phiếu giảm giá</a>
            <a class="nav-link" href="<?php echo site_url("admin/child-panels"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/child-panels.png"); ?>"> SMM Panel</a>
            <a style="font-size:14px;" class="nav-link" href="<?php echo site_url("admin/payments/bank"); ?>"><img
                class="img-responsive nav-li-href-logo" height="30" width="30"
                src="<?php echo site_url("img/admin/payment-notifications.png"); ?>"> Thông báo thanh toán</a>
          </div>
        </li>
        ...
        <li>
          <a class="nav-link" href="<?php echo site_url("admin/appearance"); ?>">
            <img class="img-responsive nav-li-href-logo" height="30" width="30"
              src="<?php echo site_url("img/admin/appearance.png"); ?>"><span class="links_name"> Vẻ bề ngoài</span>
          </a>
        </li>
        ...
        <li>
          <a class="nav-link" href="<?php echo site_url("admin/manager"); ?>">
            <img class="img-responsive nav-li-href-logo" height="30" width="30"
              src="<?php echo site_url("img/admin/manager.png"); ?>"><span class="links_name"> Quản lý</span>
          </a>
        </li>
        ...
        <li>
          <a class="nav-link" href="<?php echo site_url("admin/account"); ?>">
            <img class="img-responsive nav-li-href-logo" height="30" width="30"
              src="<?php echo site_url("img/admin/admin.png"); ?>"><span class="links_name"> Tài khoản Admin</span>
          </a>
        </li>
        ...
        <li>
          <a class="nav-link" href="<?php echo site_url("admin/logout"); ?>">
            <img class="img-responsive nav-li-href-logo" height="30" width="30"
              src="<?php echo site_url("img/admin/logout.png"); ?>"><span class="links_name"> Đăng xuất</span>
          </a>
        </li>
