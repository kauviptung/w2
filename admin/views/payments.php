...
<div class="container-fluid">
   ...
   <ul class="nav nav-tabs">
        <li class="p-b">
         ...
         <span class="export-title">Thêm/Xóa số dư</span>
         </button>
      </li>
...
<strong style='background-color:green;color:white;'>Hoàn thành</strong>
<?php endif; ?>
</td>
<td style="width:30%"><?php echo $payment["method_name"] ?> - <?php if( $payment["payment_mode"] == "Auto" ): ?>Automatic
<?php else: ?>
Manual<?php endif; ?><br>Order ID:<?php echo $payment["payment_extra"] ?> <br>Lưu ý đặc biệt :- <?php echo $payment["payment_note"] ?></td>
                 ...
                 <td class="service-block__action">
                   <div class="dropdown pull-right">
                     ...
                     <?php if( $payment["payment_mode"] == "Auto" ): ?>
                       <li><a href="#"  data-toggle="modal" data-target="#modalDiv" data-action="payment_detail" data-id="<?php echo $payment["payment_id"] ?>">Chi tiết thanh toán</a></li>
                     <?php endif; ?>
